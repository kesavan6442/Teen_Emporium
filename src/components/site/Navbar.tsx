            ...
            {cart.length > 0 && (
              <div className="p-6 border-t border-white/10 bg-white/[0.01] space-y-4">
                ...
                <a
                  ...
                  className="w-full flex items-center justify-center gap-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white py-3 text-sm font-bold tracking-wide transition-all shadow-lg hover:shadow-emerald-900/10 cursor-pointer"
                >
